...
public class Game {
    ...
    /**
     * Performs the winner checks and displays a message if game is over
    ...
    /**
     * Checks if a player has a complete row, column or diagonal
     * @param grid 2D array of characters representing the game board
     * @param player is the character we are testing for
     * @return boolean indicating "true" if player wins else false
     */
    public boolean checkPlayer(char [][]grid, char player) {
        if (// check each row
